...
import com.sv.corebackend.controller.usermanagement.UserController;
...
public class UserControllerTest {
    ...
    public void emailValidationFailTest() throws Exception {
        ...
        userDto.setRoles("EMPLOYEE");
        APIResponse responseDTO = APIResponse.getApiResponse();
        responseDTO.setMessage(UMAPIResponseMessage.USER_CREATION_FAILED);
    ...
    public void updateUserByIdFail() throws Exception {
        ...
        responseDTO.setSuccess(false);
        responseDTO.setData(null);
        responseDTO.setStatus(APIResponseStatus.ERROR);
        UserDTO userDto = new UserDTO();
        userDto.setId(1L);
